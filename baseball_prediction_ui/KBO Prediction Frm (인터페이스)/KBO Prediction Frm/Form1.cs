...
namespace KBO_Prediction_Frm
{
    ...
    {
        /* SQL 접속 정보
         * aws rds: baseball-prediction // id: root; pw: lab4012017
         */
        String connectionString = "User ID=root;"
                                + "password=lab4012017;CharSet = UTF8;"
                                + "Data Source = baseball-prediction.cncwyzazxn7z.ap-northeast-2.rds.amazonaws.com;"
                                + "Initial Catalog=baseball;"
